...
#
# Script generated by Vivado on Wed Mar 27 17:57:36 +07 2024
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/usr/local/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/usr/local/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/usr/local/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/usr/local/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../hw.gen/sources_1/bd/design_1/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_15 $xmvlog_opts -sv +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/usr/local/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../hw.gen/sources_1/bd/design_1/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_17 $xmvlog_opts -sv +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/usr/local/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../hw.gen/sources_1/bd/design_1/ipshared/6b2b/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/usr/local/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work generic_baseblocks_v2_1_1 $xmvlog_opts +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/usr/local/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../hw.gen/sources_1/bd/design_1/ipshared/10ab/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_29 $xmvlog_opts +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/usr/local/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../hw.gen/sources_1/bd/design_1/ipshared/ff9f/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_9 $xmvlog_opts +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/usr/local/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_data_fifo_v2_1_28 $xmvlog_opts +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/usr/local/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../hw.gen/sources_1/bd/design_1/ipshared/279e/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_crossbar_v2_1_30 $xmvlog_opts +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/usr/local/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_protocol_converter_v2_1_29 $xmvlog_opts +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/usr/local/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/tamamo/Documents/ENE331_workspace/ENE331-Embedded/Cora-Z7-07S-XADC-hw.xpr/hw/hw.cache/compile_simlib/xcelium"
  fi
